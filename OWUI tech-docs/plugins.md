[Skip to main content](https://docs.openwebui.com/features/plugin/#__docusaurus_skipToContent_fallback)
...
## TL;DR [​](https://docs.openwebui.com/features/plugin/\#tldr "Direct link to TL;DR")
...
## What are "Tools" and "Functions"? [​](https://docs.openwebui.com/features/plugin/\#what-are-tools-and-functions "Direct link to What are \"Tools\" and \"Functions\"?")
...
### Tools [​](https://docs.openwebui.com/features/plugin/\#tools "Direct link to Tools")
...
#### Example of a Tool: [​](https://docs.openwebui.com/features/plugin/\#example-of-a-tool "Direct link to Example of a Tool:")
...
#### Examples of Tools (extending LLM’s abilities): [​](https://docs.openwebui.com/features/plugin/\#examples-of-tools-extending-llms-abilities "Direct link to Examples of Tools (extending LLM’s abilities):")

1. **Real-time weather predictions** 🛰️.
2. **Stock price retrievers** 📈.
3. **Flight tracking information** ✈️.

### Functions [​](https://docs.openwebui.com/features/plugin/\#functions "Direct link to Functions")
...
#### Let's break that down: [​](https://docs.openwebui.com/features/plugin/\#lets-break-that-down "Direct link to Let's break that down:")
...
### Summary of Differences: [​](https://docs.openwebui.com/features/plugin/\#summary-of-differences "Direct link to Summary of Differences:")
...
## What are Pipelines? [​](https://docs.openwebui.com/features/plugin/\#what-are-pipelines "Direct link to What are Pipelines?")
...
### But here’s the thing… [​](https://docs.openwebui.com/features/plugin/\#but-heres-the-thing "Direct link to But here’s the thing…")
...
## Want to Try? 🚀 [​](https://docs.openwebui.com/features/plugin/\#want-to-try- "Direct link to Want to Try? 🚀")
...
- [TL;DR](https://docs.openwebui.com/features/plugin/#tldr)
- [What are "Tools" and "Functions"?](https://docs.openwebui.com/features/plugin/#what-are-tools-and-functions)
  - [Tools](https://docs.openwebui.com/features/plugin/#tools)
  - [Functions](https://docs.openwebui.com/features/plugin/#functions)
  - [Summary of Differences:](https://docs.openwebui.com/features/plugin/#summary-of-differences)
- [What are Pipelines?](https://docs.openwebui.com/features/plugin/#what-are-pipelines)
  - [But here’s the thing…](https://docs.openwebui.com/features/plugin/#but-heres-the-thing)
- [Want to Try? 🚀](https://docs.openwebui.com/features/plugin/#want-to-try-)