[Skip to main content](https://docs.openwebui.com/getting-started/advanced-topics/logging/#__docusaurus_skipToContent_fallback)

On this page

## Browser Client Logging [​](https://docs.openwebui.com/getting-started/advanced-topics/logging/\#browser-client-logging "Direct link to Browser Client Logging")
...
## Application Server/Backend Logging [​](https://docs.openwebui.com/getting-started/advanced-topics/logging/\#application-serverbackend-logging "Direct link to Application Server/Backend Logging")
...
### Logging Levels [​](https://docs.openwebui.com/getting-started/advanced-topics/logging/\#logging-levels "Direct link to Logging Levels")
...
### Global [​](https://docs.openwebui.com/getting-started/advanced-topics/logging/\#global "Direct link to Global")

The default global log level of `INFO` can be overridden with the `GLOBAL_LOG_LEVEL` environment variable. When set, this executes a [basicConfig](https://docs.python.org/3/library/logging.html#logging.basicConfig) statement with the `force` argument set to _True_ within `config.py`. This results in reconfiguration of all attached loggers:
...
### App/Backend [​](https://docs.openwebui.com/getting-started/advanced-topics/logging/\#appbackend "Direct link to App/Backend")
...
- [Browser Client Logging](https://docs.openwebui.com/getting-started/advanced-topics/logging/#browser-client-logging)
- [Application Server/Backend Logging](https://docs.openwebui.com/getting-started/advanced-topics/logging/#application-serverbackend-logging)
  - [Logging Levels](https://docs.openwebui.com/getting-started/advanced-topics/logging/#logging-levels)
  - [Global](https://docs.openwebui.com/getting-started/advanced-topics/logging/#global)
  - [App/Backend](https://docs.openwebui.com/getting-started/advanced-topics/logging/#appbackend)